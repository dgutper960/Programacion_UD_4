...
public class ArraysMetodos {
    public static void main(String[] args) {
        ...
        //6.- Ahora vamos a incluir como parámetro una variable a de tipo array unidimensional
        // de elementos tipo Double inicializada a los valores que  desemos.
        // Probamos igualmente si cambia tras la invocación del método o no.
        // El cambio que realizará el método sobre el parámetro tipo array será el de incrementar
        // en 1 las posiciones primera (no la 1, sino la primera), última y la que ocupe la posición
        // de en medio (redondeando hacia abajo. p.ej. Si tiene 4
    ...
    //3.- Crea un método "m" que no devuelva nada y reciba un parámetro de nombre x y tipo int.
    // El método incrementará en una unidad el valor del parámetro.
